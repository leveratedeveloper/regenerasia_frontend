...
const Journey: React.FC<JourneyProps> = ({ steps }) => {
  ...
  return (
    ...
    <div className="flex flex-col items-center gap-8 md:gap-12">
      {/* Title */}
      <h2
        className={`${cormorant.className} text-4xl md:text-5xl leading-[1.1] text-center text-[#3A3A3A] mb-12`}
      >
      ...
      {/* Bottom Row */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-7/10 mt-12">
