  ...
  return (
    <section className="flex flex-col items-center justify-center text-center min-h-screen px-4 py-12">
      ...
      <a
        ...
        className="font-helvetica px-5 py-2.5 border border-white/40 text-[16px] sm:text-[18px] md:text-[20px] text-white hover:bg-white/10 transition drop-shadow-lg backdrop-blur-[24px] mt-5 rounded-full"
      >
        Book a Session Now
      </a>
    </section>
